...
class Dashboard(rest.Resource):
    ...
    module_template_0 = '<div class="col-md-3"><div class="card card-|module_state|"><div class="card-header"><h4 class="card-title">Modül : |module_id| - |module_name|</h4></div><div class="card-body" style="display: block;"><button type="button"  class="btn btn-|module_off|"  value="|module_power|" id="module_off_|module_id|" >|module_power_state|</button></div></div></div></div>'
